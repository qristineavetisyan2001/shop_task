    ...
    <section class="text-center text-lg-start">
        ...
        <div class="container py-4 d-flex justify-content-center align-items-center mt-3 login_container">
            ...
            ">
                ...
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <img src="https://e1.pxfuel.com/desktop-wallpaper/201/872/desktop-wallpaper-wlop-digital-art-artwork-%E2%80%A2-for-you-aeolian-thumbnail.jpg" class="w-100 h-25  shadow-4" alt=""/>
                </div>
            </div>
        </div>
    </section>
